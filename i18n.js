...
(function () {
  ...
  const translations = {
    ...
    'map.panel_safe_sub1':       { es: '0 alertas activas en {m}m',                         en: '0 active alerts in {m}m' },
    ...
    'map.panel_title_many': { es: '{n} alertas en un radio de 100m', en: '{n} alerts within 100m' },
    'map.panel_sub_one':    { es: 'Hay 1 alerta activa en un radio de 100m', en: 'There is 1 active alert within 100m' },
    ...
    'map.own_panel_reach':      { es: 'Alcance estimado 100 metros',           en: 'Estimated reach: 100 meters' },
