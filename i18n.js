...
(function () {
  ...
  const translations = {
    ...
    'map.panel_title_many': { es: '{n} alertas en un radio de 50m', en: '{n} alerts within 50m' },
    'map.panel_sub_one':    { es: 'Hay 1 alerta activa en un radio de 50m', en: 'There is 1 active alert within 50m' },
